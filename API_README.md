...
> This document covers the customer-facing mobile app APIs for the Sidi project.
> Beautician-only endpoints are intentionally omitted.
...
> Note: This cosmetics section is included for completeness, but does not require customer-facing Beautician API integration.
