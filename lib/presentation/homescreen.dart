    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
            ...
            children: [
              IconButton(
                icon: Icon(Icons.location_on_outlined, size: 20, color: opacity(kCharcoalColor, 0.7)),
                onPressed: () {},
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const DetailedServiceScreen()));
                    },
                    child: Text(
                      "BOOK NOW",
                      style: GoogleFonts.inter(
